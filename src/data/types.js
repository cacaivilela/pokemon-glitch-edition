...
// os Pokémon de Hoenn (nenhum de Kanto é desse tipo), e FADA entrou junto com o
// XERNEAS — ele não existe sem ela. Nenhum dos 151 é de um desses dois tipos:
// eles só encostam no jogo pelo que vem de fora.
export const TYPES = [
  "NORMAL", "LUTADOR", "VOADOR", "VENENO", "TERRA", "PEDRA", "INSETO", "FANTASMA",
  "AÇO", "FOGO", "ÁGUA", "PLANTA", "ELÉTRICO", "PSÍQUICO", "GELO", "DRAGÃO", "SOMBRIO",
  "FADA", "GLITCH",
];
...
export const TYPE_COLOR = {
  ...
  SOMBRIO: "#705848", FADA: "#ee99ac", GLITCH: "#b455ff",
};

// CHART[atacante][defensor] = multiplicador (omitido = 1)
export const CHART = {
  NORMAL:     { PEDRA: 0.5, "AÇO": 0.5, FANTASMA: 0, GLITCH: 0 },
  LUTADOR:    { NORMAL: 2, PEDRA: 2, "AÇO": 2, GELO: 2, SOMBRIO: 2, VOADOR: 0.5, VENENO: 0.5, "PSÍQUICO": 0.5, INSETO: 0.5, FANTASMA: 0, FADA: 0.5 },
  ...
  INSETO:     { PLANTA: 2, "PSÍQUICO": 2, SOMBRIO: 2, GLITCH: 2, FOGO: 0.5, LUTADOR: 0.5, VENENO: 0.5, VOADOR: 0.5, FANTASMA: 0.5, "AÇO": 0.5, FADA: 0.5 },
  FANTASMA:   { "PSÍQUICO": 2, FANTASMA: 2, SOMBRIO: 0.5, NORMAL: 0, "AÇO": 0.5 },
  "AÇO":      { PEDRA: 2, GELO: 2, FADA: 2, "AÇO": 0.5, FOGO: 0.5, "ÁGUA": 0.5, "ELÉTRICO": 0.5 },
  ...
  SOMBRIO:    { "PSÍQUICO": 2, FANTASMA: 2, LUTADOR: 0.5, SOMBRIO: 0.5, "AÇO": 0.5, FADA: 0.5 },
  FADA:       { LUTADOR: 2, "DRAGÃO": 2, SOMBRIO: 2, FOGO: 0.5, VENENO: 0.5, "AÇO": 0.5 },
