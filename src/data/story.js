...
export const STORY = {
  ...
  glitch: {
    explica: [
      "PROF. CARVALHO: ESSE VISOR NÃO SERVE SÓ PRA ENXERGAR FRAGMENTO, SABIA?",
      "ELE LÊ A GLITCHFORM — O ESTADO EM QUE UM POKÉMON DEIXA DE SER DADO CERTO E VIRA DADO SOLTO.",
      "COM ELE NO ROSTO, DÁ PRA USAR UMA COISA CHAMADA GLITCHBOOSTER.",
      "É UM SÓ, E ELE NÃO GASTA. COMPRE UMA VEZ E ELE FICA NA SUA MOCHILA PRA SEMPRE.",
      "O BICHO VIRA UM BUG: CADA PONTO DE DANO QUE ELE TOMA VIRA PONTO DE ATRIBUTO. TUDO, MENOS O HP.",
      "MAS O NÚMERO QUE SEGURA ISSO É DE UM BYTE SÓ. PASSOU DE 255, VOLTA PRO ZERO.",
      "APANHAR É A FORÇA. APANHAR DEMAIS É A QUEDA. NÃO DIGA QUE EU NÃO AVISEI.",
    ],
    liberou: "AS LOJAS AGORA VENDEM GLITCHBOOSTER.",
    semVisor: "PROF. CARVALHO: VOLTE QUANDO O CONOR TE DER O VISOR-G.L.I.T.C.H.",
    usou: "{NOME} VIROU UM BUG! O DANO AGORA VIRA ATRIBUTO.",
    ...
    rasgoEntrou: ["VOCÊ ENCOSTA NO RASGO. UMA COISA GRANDE DEMAIS PASSA POR ELE."],
    rasgoVazio: ["O RASGO SE FECHA SOZINHO. O QUE IA SAIR DESISTIU."],
    raidApareceu: [
      "A FENDA ABRIU MAIS DO QUE DEVIA.",
      "ISSO NÃO É UM POKÉMON SELVAGEM. É UMA GLITCH RAID.",
    ],
    raidBugado: "{NOME} JÁ VEM BUGADO: CADA PONTO DE DANO QUE ELE TOMAR VIRA ATRIBUTO. BATER NELE O DEIXA MAIOR.",
